        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-md-10 mx-auto col-12">
                <div class="hero-text mt-5 text-center">
                    ...
                    <h1 class="text-white" data-aos="fade-up" data-aos-delay="500"><De></De> geweldige acteurs van onze exclusive CineFlex films
                    </h1>
                </div>
            </div>
        ...
        <table class="txtalign" style="width:100%">
            ...
            <?php while($r = $stmt->fetch(PDO::FETCH_ASSOC)) {
                ...
                <tr>
                    ...
                    <td>
                        <?php echo '<a href="index.php?page=acteurbewerken&acteur_id='.$r['acteur_id'].'" class="btn btn-primary">Bewerk</a>'; ?>">
                    </td>
                    <td>
            ...
            <a href = "index.php?page=acteurtoevoegen">
                <input class="btn btn-success" type="submit" name="" value="Acteur toevoegen">
            </a>
            <br><br>
